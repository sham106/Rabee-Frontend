      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1.7fr)_minmax(320px,0.7fr)]">
        <motion.section initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="relative overflow-hidden rounded-[2rem] bg-slate-950 p-5 text-white shadow-xl shadow-slate-950/10 sm:p-7">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            ...
            <button type="button" onClick={onOpenAddRecords} className="group flex items-center justify-between gap-5 rounded-2xl bg-amber-400 px-4 py-3 text-left text-slate-950 shadow-lg shadow-amber-500/10 transition hover:bg-amber-300 lg:min-w-52"><span className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-950 text-amber-300"><PackageCheck className="h-5 w-5" /></span><span><span className="block text-sm font-black">Assign parcels</span><span className="block text-[10px] font-bold text-slate-700">Choose rider & quantity</span></span></span><ArrowRight className="h-5 w-5 transition-transform group-hover:translate-x-1" /></button>
          </div>
        </motion.section>
